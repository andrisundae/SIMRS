...
class List extends Component {
    ...
    render() {
        let { isDisableForm, subResource, sizeColumnsToFit, containerHeight } = this.props;
    ...
    _getDataSource() {
        ...
        return {
            ...
            getRows: (params) => {
                ...
                post.sort_name = post.sort_name === 'string_aktif' ? 'aktif' : post.sort_name;

                if (_this.props.filterPost.filter_value.toString().length < _this.props.minCharSearch) {
                    post.filter_value = '';
                }
    ...
    componentDidUpdate(prevProps) {
        let { isDisableForm, statusForm, isReloadGrid, selectedRow, reloadType } = this.props;
    ...
    _onRowSelected(params) {
        if (params.node.isSelected()) {
            this.props.action.onSelected(this.props.resource, this.props.subResource, params.data);
        }
    }
...
const mapStateToProps = function (state, props) {
    ...
    if (state.datatable.datatables) {
        isReloadGrid = state.datatable.datatables[props.subResource].isReload;
        reloadType = state.datatable.datatables[props.subResource].reloadType;
    } else {
