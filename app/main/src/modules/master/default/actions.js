...
export const moduleActions = {
    ...
    onAdd: (resource) => createAction(
        moduleActionTypes.ADD, {}, { resource, log: createActivity(resource, activity.TAMBAH) }
    ),
    ...
    onAfterSave: (resource) => createAction(moduleActionTypes.AFTER_SAVE, {}, { resource }),
    onChangeInput: (resource, data) => createAction(moduleActionTypes.CHANGE_INPUT, { data }, { resource }),
