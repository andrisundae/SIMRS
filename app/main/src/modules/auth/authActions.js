...
export default {
  ...
  //     {}
  // ),
  showDialogForceLogin: (isShow) =>
    createAction(actionTypes.LOGIN_FORCE_SHOW_DIALOG, { isShow }, {}),
  ...
  userCheck: (data) => createAction(actionTypes.USER_CHECK, { data }, {}),
  ...
  resetPassword: {
    ...
    requestSuccess: (resource, data) =>
      createAction(
        ...
        {
          resource,
          log: createActivity(resource, activity.RESET_PASSWORD, 'sukses'),
        }
      ),
    requestFailure: (resource, error) =>
      createAction(
        ...
        {
          resource,
          log: createActivity(resource, activity.RESET_PASSWORD, 'gagal'),
        }
      ),
  },
  forceLogout: {
    ...
    requestSuccess: (resource, data) =>
      createAction(
        ...
        {
          resource,
          log: createActivity(resource, activity.FORCE_LOGOUT, 'sukses'),
        }
      ),
    requestFailure: (resource, error) =>
      createAction(
        ...
        {
          resource,
          log: createActivity(resource, activity.FORCE_LOGOUT, 'gagal'),
        }
      ),
  },
};
