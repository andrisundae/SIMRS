...
class Login extends Component {
        ...
        return (
            <Form onSubmit={this.handleSubmit}>
                ...
                {notification.message &&
                    <Message negative content={notification.message}/>
                }
                <Form.Field error={(isSubmitted && errors.username) ? true : false}>
                    ...
                    {isSubmitted && errors.username &&
                        <Label basic color="red" pointing>{_.first(errors.username)}</Label>
                    }
                </Form.Field>
                <Form.Field error={(isSubmitted && errors.password) ? true : false}>
                    ...
                    {isSubmitted && errors.password &&
                        <Label basic color="red" pointing>{_.first(errors.password)}</Label>
                    }
                </Form.Field>
                <Button
    ...
    componentDidUpdate(prevProps) {
        ...
        if (this.props.dialogForceLogin === true && prevProps.dialogForceLogin === false) {
            confirmation({
                title: this.props.t(`main:dialog.confirmation.title`),
                message: this.props.t('main:dialog.confirmation.forcelogin'),
                buttons: [this.props.t(`main:dialog.action.yes`), this.props.t(`main:dialog.action.no`)],
