...
class SaveButton extends PureComponent {
    render() {
        ...
        return (
            <Button ref={inputRef} name="save" color="green" size="mini" {...attributes}>
                <Icon name='save' />
...
class AddButton extends PureComponent {
    render() {
        let { inputRef, ...attributes } = this.props;
        return (
            <Button ref={inputRef} name="add" color="blue" size="mini" {...attributes}>
                <Icon name='plus' />
...
class EditButton extends PureComponent {
    render() {
        let { inputRef, ...attributes } = this.props;
        return (
            <Button ref={inputRef} name="edit" color="teal" size="mini" {...attributes}>
                <Icon name='edit' />
...
class DeleteButton extends PureComponent {
    render() {
        let { inputRef, ...attributes } = this.props;
        return (
            <Button ref={inputRef} name="delete" color="red" size="mini" {...attributes}>
                <Icon name='trash' />
...
class SearchButton extends PureComponent {
    render() {
        let { inputRef, ...attributes } = this.props;
        return (
            <Button  ref={inputRef} name="search" color="blue" size="mini" {...attributes}>
                <Icon name='search' />
...
class NextButton extends PureComponent {
    render() {
        let { inputRef, ...attributes } = this.props;
        return (
            <Button ref={inputRef} name="next" size="mini" {...attributes}><Icon name='forward' />
...
class PrevButton extends PureComponent {
    render() {
        let { inputRef, ...attributes } = this.props;
        return (
            <Button ref={inputRef} name="prev" size="mini" {...attributes}><Icon name='backward' />
...
class ImportButton extends PureComponent {
    render() {
        let { inputRef, ...attributes } = this.props;
        return (
            <Button ref={inputRef} name="import" color="blue" size="mini" {...attributes}>
...
class ExportButton extends PureComponent {
    render() {
        let { inputRef, ...attributes } = this.props;
        return (
            <Button ref={inputRef} name="export" color="green" size="mini" {...attributes}>
                <Icon name='file excel' />
...
class PreviewButton extends PureComponent {
    render() {
        let { inputRef, ...attributes } = this.props;
        return (
            <Button ref={inputRef} name="preview" color="blue" size="mini" {...attributes}>
                <Icon name='search' />
