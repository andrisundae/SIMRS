...
class Main extends Component {
    constructor(props) {
        ...
        this.subResource = '_billing_master_diagnosis_ix';
    }
    ...
    render() {
        return (
            <Module
                ...
                caption={this.props.t(`${this.props.resource}:diagnosis.title`, { versi: this.props.location.state.nama_versi})}
                isChildren={true}
    ...
    componentDidMount() {
        this.props.action.openForm(this.props.resource, this.subResource, { versi_diagnosis_ix: this.props.match.params.versi });
    }
