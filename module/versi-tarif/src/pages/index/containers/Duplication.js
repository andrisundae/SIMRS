    ...
    return (
      ...
      >
        <Modal.Header>
          ...
          {t(this._getKey('duplikasi.title'))}
        </Modal.Header>
        <Modal.Content>
                  ...
                  <Grid className="form-grid">
                    <Grid.Row className="form-row">
                      <Grid.Column width="3" className="required field">
                        <label>
                          {t(this._getKey('label.field.versi_tarif_tujuan'))}
                        </label>
                      </Grid.Column>
                      <Grid.Column width="8" className="field">
                        <Input value={selectedTujuan.nama} disabled={true} />
                      </Grid.Column>
                    </Grid.Row>
                    <Grid.Row className="form-row">
                      <Grid.Column width="3" className="required field">
                        <label>
                          {t(this._getKey('label.field.versi_tarif_asal'))}
                        </label>
                      </Grid.Column>
                      <Grid.Column width="8" className="field">
                        <Input value={selectedAsal.nama} disabled={true} />
                      </Grid.Column>
                    </Grid.Row>
                  </Grid>
                </Form>
  ...
  _getDataSource() {
    ...
    return {
      ...
      getRows: (params) => {
        ...
        _this.props.action.loadAllOnDuplication(
    ...
    return [
      ...
      },
      {
        headerName: this.props.t(
          `${this.props.resource}:header.column.tgl_aktif_tarif`
        ),
