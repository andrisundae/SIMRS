...
import ScreeningDecubitusNortonScaleLabel from './Label';

export default function Add() {
  const history = useHistory();
  const formLabel = ScreeningDecubitusNortonScaleLabel.formLabel;
  ...
  function getDefaultOptionValue(type) {
    let data = _.filter(ScreeningDecubitusNortonScaleLabel[type], 'default');
    if (data.length > 0) {
  ...
  function renderOptionData(type) {
    return ScreeningDecubitusNortonScaleLabel[type].map((data) => {
      return {
        key: data.key,
  ...
  return (
    <Fragment>
      <Modal.Header className="text-xl">
        ...
        {ScreeningDecubitusNortonScaleLabel.headerLabel}
      </Modal.Header>
            ...
            <Grid.Column>
              <label className="block">
                <Select
                  clearable
                  fluid
                  options={renderOptionData('fisik')}
                  defaultValue={getDefaultOptionValue('fisik')}
                  onChange={(e, { value }) =>
            ...
            <Grid.Column>
              <label className="block">
                <Select
                  clearable
                  fluid
                  options={renderOptionData('kesadaran')}
                  defaultValue={getDefaultOptionValue('kesadaran')}
                  onChange={(e, { value }) =>
            ...
            <Grid.Column>
              <label className="block">
                <Select
                  clearable
                  fluid
                  options={renderOptionData('aktifitas')}
                  defaultValue={getDefaultOptionValue('aktifitas')}
                  onChange={(e, { value }) =>
            ...
            <Grid.Column>
              <label className="block">
                <Select
                  clearable
                  fluid
                  options={renderOptionData('mobilisasi')}
                  defaultValue={getDefaultOptionValue('mobilisasi')}
                  onChange={(e, { value }) =>
            ...
            <Grid.Column>
              <label className="block">
                <Select
                  clearable
                  fluid
                  options={renderOptionData('incontinensia')}
                  defaultValue={getDefaultOptionValue('incontinensia')}
                  onChange={(e, { value }) =>
