...
class ImportDetail extends Component {
    ...
    return (
      ...
      >
        <Modal.Header>
          ...
          {t(this._getKey('import_detail.title'))}
        </Modal.Header>
        <Modal.Content>
          <Form size="small">
  ...
  _getDataSource() {
    ...
    return {
      ...
      getRows: (params) => {
        let filter = {
          instalasi: _this.props.filter.selectedInstalasi
            ? _this.props.filter.selectedInstalasi.value
            : 0,
          asal_masuk: _this.props.post.asal_masuk
            ? _this.props.post.asal_masuk
            : 0,
        };
        ...
        _this.props.action.loadAllOnImportDetail(
          _this.props.resource,
          _this.props.subResource,
          post,
          params
        );
      },
  ...
  _handleInstalasiChange(selected) {
    this.props.action.onChangeInstalasi(
      this.props.resource,
  ...
  _onCancel() {
    this.props.action.onCancelImportDetail(
      this.props.resource,
      this.props.subResource
    );
  }
