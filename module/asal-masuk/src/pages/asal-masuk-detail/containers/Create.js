...
import { isDisableForm, moduleActions as actions } from '@simrs/main/src/modules/master/nested';
...
class Create extends Component {
    ...
    render() {
        let { post, isDisableForm, t, isShowImportDetail } = this.props;
        ...
        return (
            <Fragment>
                ...
                {isShowImportDetail &&
                    <ImportDetail t={t} resource={this.props.resource} subResource={this.props.subResource} />
                }
            </Fragment>
        )
    }
...
const mapStateToProps = function (state) {
    const { post, statusForm, focusElement, isSubmitted, submitting, importDetail} = state.nested.module;
    ...
    return {
        ...
        isSubmitted,
        submitting,
        isShowImportDetail: importDetail.show,
    }
}
...
Create.propTypes = {
    ...
    isShowImportDetail: PropTypes.bool,
