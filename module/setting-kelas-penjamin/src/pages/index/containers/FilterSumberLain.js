                  ...
                  <Grid className="form-grid">
                    <Grid.Row className="form-row">
                      <Grid.Column width="3" className="field">
                        <label><Trans i18nKey={this._getKey('label.field.penjamin')} /></label>
                      </Grid.Column>
                      <Grid.Column width="11" className="field">
                        <Select
                          name="penjamin"
                          placeholder={t(this._getKey('placeholder.field.penjamin'))}
                          inputRef={this.penjamin}
                          value={this._getSelect2Value('penjamin')}
                          onChange={(selected) => this._handleSelect2SumberLain('penjamin', selected)}
                          options={dataSumberLain.penjamin}
                        />
                      </Grid.Column>
                    </Grid.Row>
                  </Grid>
