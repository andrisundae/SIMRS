...
class Main extends Component {
    ...
    render() {
        return (
            <Module
                ...
                caption={this.props.t(`${this.props.resource}:tindakan.title`, { layanan: this.props.location.state.nama_layanan})}
                isChildren={true}
    ...
    componentDidMount() {
        this.props.action.openForm(
            this.props.resource,
            this.subResource,
            { layanan: this.props.match.params.layanan, selectedVersiTarif: this.props.location.state.selectedVersiTarif }
        );
    }
