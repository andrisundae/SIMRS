...
class Main extends Component {
    constructor(props) {
        ...
        this.subResource = '_billing_master_diagnosis_x';
    }
    ...
    componentDidMount() {
        this.props.action.openForm(this.props.resource, this.subResource, { versi_diagnosis_x: this.props.match.params.versi });
    }
