...
class Main extends Component {
    constructor(props) {
        ...
        this.subResource = '_billing_master_wilayah_kecamatan';
    }
    ...
    render() {
        return (
            <Module
                ...
                caption={this.props.t(`${this.props.resource}:kecamatan.title`) + ` Kota ${this.props.location.state.nama_kota}`}
                isChildren={true}
    ...
    componentDidMount() {
        this.props.action.openForm(this.props.resource, this.subResource, { kota: this.props.match.params.kota });
    }
