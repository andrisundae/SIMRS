...
const mapStateToProps = function (state, props) {
    ...
    return {
        customPermissions: {
            canAdd: isGranted(props.permissions, 'tambah_kecamatan'),
            canEdit: isGranted(props.permissions, 'koreksi_kecamatan'),
            canDelete: isGranted(props.permissions, 'hapus_kecamatan')
        },
    }
}
