...
class Filter extends Component {
    ...
    _getFilterColumns() {
        return [
            { key: 'kode_kecamatan', value: 'kode_kecamatan', text: this.props.t(this._getKey('header.column.kode')) },
    ...
    _onClickNext(e) {
        ...
        this.props.history.push({
            pathname: `/desa/${this.props.selectedRow}`,
            state: {
                ...this.props.location.state,
                desa: true,
                id_kecamatan: this.props.selectedRow,
                nama_kecamatan: this.props.post.nama
            }
        });
    }
    ...
    _onClickPrev(e) {
        e.preventDefault();
        this.props.history.push({
            pathname: `/kota/${this.props.location.state.id_provinsi}`,
            state: {
                ...this.props.location.state,
            }
        });
