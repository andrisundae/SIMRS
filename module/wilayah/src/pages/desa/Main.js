...
class Main extends Component {
    constructor(props) {
        ...
        this.subResource = '_billing_master_wilayah_desa';
    }
    ...
    render() {
        return (
            <Module
                ...
                caption={this.props.t(`${this.props.resource}:desa.title`) + ` Kecamatan ${this.props.location.state.nama_kecamatan}`}
                isChildren={true}
    ...
    componentDidMount() {
        this.props.action.openForm(this.props.resource, this.subResource, { kecamatan: this.props.match.params.kecamatan });
    }
