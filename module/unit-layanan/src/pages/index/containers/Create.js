...
class Create extends Component {
                    ...
                    <Checkbox
                      ...
                      onKeyDown={(e) =>
                        this._onFocusElement(
                          e,
                          this._isRawatInap() ? 'st_asal_kunjungan' : 'kategori'
                        )
                      }
                      inputRef={this.aktif}
                    ...
                    {this._isRawatInap() && (
                      <Fragment>
                        ...
                        <Checkbox
                          ...
                          label={t(
                            this._getKey('sublabel.field.asal_kunjungan')
                          )}
                        />
                      </Fragment>
                    )}
              ...
              <Grid className="form-grid">
                ...
                <Grid.Row className="form-row">
                  ...
                  <Grid.Column width="12" className="field">
                    <Select
                      name="kategori"
                      placeholder={t(
                        this._getKey('placeholder.field.kategori')
                      )}
                      ...
                      onKeyDown={(e) =>
                        this._onFocusElement(
                          e,
                          this._isKategoriAnak() ? 'umur1' : 'save'
                        )
                      }
                ...
                {this._isKategoriAnak() === true && (
                  <Grid.Row className="form-row" style={{ marginTop: 10 }}>
                    <Grid.Column width="4" className="field">
                      <label>
                        {t(this._getKey('label.field.rentang_umur'))}
                      </label>
                    </Grid.Column>
                    <Grid.Column width="4" className="field">
                      <Input
                    ...
                    <Grid.Column width="4" className="field">
                      ...
                      />
                      <Label floating>
                        {post.kategori === 'ANAK' && 'Tahun'}
                        {post.kategori === 'BAYI' && 'Hari'}
                      </Label>
                    </Grid.Column>
                  </Grid.Row>
                )}
  ...
  _isKategoriAnak() {
    ...
    return post.kategori !== 'UMUM' &&
      post.kategori !== 'GERIYATRI' &&
      post.kategori !== ''
      ? true
      : false;
  }
