...
class Filter extends Component {
    ...
    _getFilterColumns() {
        return [
            { key: 'instalasi', value: 'instalasi', text: this.props.t(this._getKey('header.column.instalasi')) },
            { key: 'nama', value: 'nama', text: this.props.t(this._getKey('header.column.nama')) },
            { key: 'inisial', value: 'inisial', text: this.props.t(this._getKey('header.column.inisial')) },
        ];
    }
}
