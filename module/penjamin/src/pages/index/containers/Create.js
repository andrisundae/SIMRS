              ...
              <Grid>
                <Grid.Row className="form-row">
                  ...
                  <Grid.Column width="12" className="field">
                    <Select
                      ...
                      onKeyDown={(e) =>
                        this._onFocusElement(e, 'jaminan_penuh')
                      }
                ...
                <Grid.Row className="form-row">
                  <Grid.Column width="4" className="field">
                    <label>
                      {t(this._getKey('label.field.jaminan_penuh'))}
                    </label>
                  </Grid.Column>
                  <Grid.Column width="12" className="inline field">
                    <Radio
                      ...
                      onKeyDown={(e) =>
                        this._onFocusElement(e, 'input_jaminan')
                      }
                ...
                <Grid.Row className="form-row">
                  ...
                  <Grid.Column width="12" className="field">
                    <Checkbox
                      ...
                      onChange={this._handleInputChange}
                      onKeyDown={(e) =>
                        this._onFocusElement(e, 'st_naik_satu_tingkat')
                      }
                      inputRef={this.aktif}
                    ...
                    <Checkbox
                      ...
                      label={t(
                        this._getKey('sublabel.field.st_naik_satu_tingkat')
                      )}
                    />
                  </Grid.Column>
                </Grid.Row>
