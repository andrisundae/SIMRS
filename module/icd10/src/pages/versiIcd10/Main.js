...
class Main extends Component {
  constructor(props) {
    ...
    this.subResource = '_rekam_medis_versiIcd10_icd10';
  }
  ...
  render() {
    return (
      <Module
        ...
        caption={this.props.t(`${this.props.resource}:versi_icd10.title`)}
...
const mapDispatchToProps = function (dispatch) {
  return {
    openForm: (resource, subResource) =>
      dispatch(moduleActions.openForm(resource, subResource)),
  };
};
