...
class Main extends Component {
  constructor(props) {
    ...
    this.subResource = '_rekam_medis_icd10';
  }
  ...
  render() {
    ...
    return (
      <Module
        ...
        caption={this.props.t(`${this.props.resource}:icd10.title`, {
          versiIcd10: queryString.get('nama_versiIcd10'),
        })}
        isChildren={true}
  ...
  componentDidMount() {
    this.props.action.openForm(this.props.resource, this.subResource, {
      id_versi_icd10: this.props.match.params.versiIcd10,
    });
  }
