  ...
  return (
    <Grid>
      <Grid.Row columns="equal">
        ...
        <Grid.Column>
          {CheckboxOptions.kulit.bersalin.luka.map((data) => {
            return (
              <label
                key={data.key}
      ...
      </Grid.Row>
      {
        <Fragment>
          <Grid.Row columns="equal" className="pb-0">
            ...
            <Grid.Column>
              {RadioOptions.kulit.bersalin.jenis_luka.map((data) => {
                return (
                  <label
                    key={data.key}
                    className={'block ' + (data.key === 0 ? '' : 'mt-3')}
            ...
            <Grid.Column>
              <label className="block">
                <Select
                  clearable
                  fluid
                  options={DropdownOptions.kulit.bersalin.penyebab_luka}
                />
              </label>
            ...
            <Grid.Column>
              <label className="block">
                <Select
                  clearable
                  fluid
                  options={DropdownOptions.kulit.bersalin.tanda_peradangan}
                />
              </label>
              <label className="block mt-2">
                <Input fluid placeholder="Lainnya, jika ada" />
