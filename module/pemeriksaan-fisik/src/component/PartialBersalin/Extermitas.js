        ...
        <Grid.Column>
          <label className="block">
            <Select
              clearable
              fluid
              options={DropdownOptions.extermitas.bersalin.motorik.tangan_kanan}
            />
          </label>
        </Grid.Column>
      </Grid.Row>
        ...
        <Grid.Column>
          <label className="block">
            <Select
              clearable
              fluid
              options={DropdownOptions.extermitas.bersalin.motorik.tangan_kiri}
            />
          </label>
        </Grid.Column>
      </Grid.Row>
        ...
        <Grid.Column>
          <label className="block">
            <Select
              clearable
              fluid
              options={DropdownOptions.extermitas.bersalin.motorik.kaki_kanan}
            />
          </label>
        </Grid.Column>
      </Grid.Row>
        ...
        <Grid.Column>
          <label className="block">
            <Select
              clearable
              fluid
              options={DropdownOptions.extermitas.bersalin.motorik.kaki_kiri}
            />
          </label>
        </Grid.Column>
      </Grid.Row>
        ...
        <Grid.Column>
          <label className="block">
            <Select
              clearable
              fluid
              options={DropdownOptions.extermitas.bersalin.sensorik}
            />
          </label>
        </Grid.Column>
      </Grid.Row>
      ...
      {isArteri && (
        <Fragment>
          ...
          <Grid.Row columns="equal" className="pb-0">
            ...
            <Grid.Column>
              {CheckboxOptions.extermitas.bersalin.arteri.lokasi.map((data) => {
                return (
                  <label
                    key={data.key}
          ...
          <Grid.Row columns="equal" className="pb-0 mt-2">
            ...
            <Grid.Column>
              {CheckboxOptions.extermitas.bersalin.arteri.keadaan.map(
                (data) => {
                  return (
                    <label
                      key={data.key}
          ...
          <Grid.Row columns="equal" className="pb-0 mt-2">
            ...
            <Grid.Column>
              {CheckboxOptions.extermitas.bersalin.arteri.balutan.map(
                (data) => {
                  return (
                    <label
                      key={data.key}
      ...
      {isIV && (
        <Fragment>
          ...
          <Grid.Row columns="equal" className="pb-0">
            ...
            <Grid.Column>
              {CheckboxOptions.extermitas.bersalin.iv.lokasi.map((data) => {
                return (
                  <label
                    key={data.key}
                    className={'block ' + (data.key === 0 ? '' : 'mt-3')}
          ...
          <Grid.Row columns="equal" className="pb-0 mt-2">
            ...
            <Grid.Column>
              {CheckboxOptions.extermitas.bersalin.iv.keadaan.map((data) => {
                return (
                  <label
                    key={data.key}
                    className={'block ' + (data.key === 0 ? '' : 'mt-3')}
          ...
          <Grid.Row columns="equal" className="pb-0 mt-2">
            ...
            <Grid.Column>
              {CheckboxOptions.extermitas.bersalin.iv.balutan.map((data) => {
                return (
                  <label
                    key={data.key}
                    className={'block ' + (data.key === 0 ? '' : 'mt-3')}
      ...
      {isVena && (
        <Fragment>
          ...
          <Grid.Row columns="equal" className="pb-0">
            ...
            <Grid.Column>
              {CheckboxOptions.extermitas.bersalin.vena.lokasi.map((data) => {
                return (
                  <label
                    key={data.key}
                    className={'block ' + (data.key === 0 ? '' : 'mt-3')}
          ...
          <Grid.Row columns="equal" className="pb-0 mt-2">
            ...
            <Grid.Column>
              {CheckboxOptions.extermitas.bersalin.vena.keadaan.map((data) => {
                return (
                  <label
                    key={data.key}
                    className={'block ' + (data.key === 0 ? '' : 'mt-3')}
          ...
          <Grid.Row columns="equal" className="pb-0 mt-2">
            ...
            <Grid.Column>
              {CheckboxOptions.extermitas.bersalin.vena.balutan.map((data) => {
                return (
                  <label
                    key={data.key}
                    className={'block ' + (data.key === 0 ? '' : 'mt-3')}
