  ...
  return (
    <Grid>
        ...
        <Grid.Column>
          <label className="block">
            <Select
              clearable
              fluid
              options={DropdownOptions.paru.bayi.gangguan_jalan_nafas}
            />
          </label>
        ...
        <Grid.Column>
          <label className="block">
            <Select
              clearable
              fluid
              options={DropdownOptions.paru.bayi.gangguan_pola_nafas}
            />
          </label>
          <label className="block mt-1">
            <Input fluid placeholder="Lainnya, jika ada" />
        ...
        <Grid.Column>
          <label className="block">
            <Select
              clearable
              fluid
              options={DropdownOptions.paru.bayi.suara_nafas}
            />
          </label>
          <label className="block mt-1">
            <Input fluid placeholder="Lainnya, jika ada" />
      ...
      <Grid.Row columns="equal" className="pb-0">
        ...
        <Grid.Column>
          {CheckboxOptions.paru.bayi.otot_bantu_nafas.map((data) => {
            return (
              <label
                key={data.key}
      ...
      <Grid.Row columns="equal" className="pb-0 mt-2">
        ...
        <Grid.Column>
          {RadioOptions.paru.bayi.jenis_nafas.map((data) => {
            return (
              <label
                key={data.key}
                className={'block ' + (data.key === 0 ? '' : 'mt-3')}
        ...
        <Grid.Column>
          <label className="block">
            <Select
              clearable
              fluid
              options={DropdownOptions.paru.bayi.alat_bantu}
            />
          </label>
        </Grid.Column>
      </Grid.Row>
      ...
      {isWSD1 && (
        <Fragment>
          <Grid.Row columns="equal" className="pb-0">
            ...
            <Grid.Column>
              {RadioOptions.paru.bayi.wsd1.lokasi.map((data) => {
                return (
                  <label
                    key={data.key}
                    className={'block ' + (data.key === 0 ? '' : 'mt-3')}
          ...
          <Grid.Row columns="equal" className="pb-0">
            ...
            <Grid.Column>
              {RadioOptions.paru.bayi.wsd1.undulasi.map((data) => {
                return (
                  <label
                    key={data.key}
                    className={'block ' + (data.key === 0 ? '' : 'mt-3')}
          ...
          <Grid.Row columns="equal" className="pb-0 mt-2">
            ...
            <Grid.Column>
              {RadioOptions.paru.bayi.wsd1.rembesan.map((data) => {
                return (
                  <label
                    key={data.key}
                    className={'block ' + (data.key === 0 ? '' : 'mt-3')}
          ...
          <Grid.Row columns="equal" className="pb-0">
            ...
            <Grid.Column>
              {RadioOptions.paru.bayi.wsd1.emphysema.map((data) => {
                return (
                  <label
                    key={data.key}
                    className={'block ' + (data.key === 0 ? '' : 'mt-3')}
      ...
      {isWSD2 && (
        <Fragment>
          <Grid.Row columns="equal" className="pb-0">
            ...
            <Grid.Column>
              {RadioOptions.paru.bayi.wsd2.lokasi.map((data) => {
                return (
                  <label
                    key={data.key}
                    className={'block ' + (data.key === 0 ? '' : 'mt-3')}
          ...
          <Grid.Row columns="equal" className="pb-0">
            ...
            <Grid.Column>
              {RadioOptions.paru.bayi.wsd2.undulasi.map((data) => {
                return (
                  <label
                    key={data.key}
                    className={'block ' + (data.key === 0 ? '' : 'mt-3')}
          ...
          <Grid.Row columns="equal" className="pb-0 mt-2">
            ...
            <Grid.Column>
              {RadioOptions.paru.bayi.wsd2.rembesan.map((data) => {
                return (
                  <label
                    key={data.key}
                    className={'block ' + (data.key === 0 ? '' : 'mt-3')}
          ...
          <Grid.Row columns="equal" className="pb-0">
            ...
            <Grid.Column>
              {RadioOptions.paru.bayi.wsd2.emphysema.map((data) => {
                return (
                  <label
                    key={data.key}
                    className={'block ' + (data.key === 0 ? '' : 'mt-3')}
      ...
      {isCVC && (
        <Fragment>
          ...
          <Grid.Row columns="equal" className="pb-0">
            ...
            <Grid.Column>
              {RadioOptions.paru.bayi.cvc.lokasi.map((data) => {
                return (
                  <label
                    key={data.key}
                    className={'block ' + (data.key === 0 ? '' : 'mt-3')}
          ...
          <Grid.Row columns="equal" className="pb-0 mt-2">
            ...
            <Grid.Column>
              {RadioOptions.paru.bayi.cvc.keadaan_lumens.map((data) => {
                return (
                  <label
                    key={data.key}
                    className={'block ' + (data.key === 0 ? '' : 'mt-3')}
          ...
          <Grid.Row columns="equal" className="pb-0">
            ...
            <Grid.Column>
              {CheckboxOptions.paru.bayi.cvc.keadaan.map((data) => {
                return (
                  <label
                    key={data.key}
                    className={'block ' + (data.key === 0 ? '' : 'mt-3')}
          ...
          <Grid.Row columns="equal" className="mt-2">
            ...
            <Grid.Column>
              {CheckboxOptions.paru.bayi.cvc.balutan.map((data) => {
                return (
                  <label
                    key={data.key}
                    className={'block ' + (data.key === 0 ? '' : 'mt-3')}
