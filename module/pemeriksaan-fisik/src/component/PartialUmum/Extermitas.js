        ...
        <Grid.Column>
          <label className="block">
            <Select
              clearable
              fluid
              options={DropdownOptions.extermitas.umum.motorik.tangan_kanan}
            />
          </label>
        </Grid.Column>
      </Grid.Row>
        ...
        <Grid.Column>
          <label className="block">
            <Select
              clearable
              fluid
              options={DropdownOptions.extermitas.umum.motorik.tangan_kiri}
            />
          </label>
        </Grid.Column>
      </Grid.Row>
        ...
        <Grid.Column>
          <label className="block">
            <Select
              clearable
              fluid
              options={DropdownOptions.extermitas.umum.motorik.kaki_kanan}
            />
          </label>
        </Grid.Column>
      </Grid.Row>
        ...
        <Grid.Column>
          <label className="block">
            <Select
              clearable
              fluid
              options={DropdownOptions.extermitas.umum.motorik.kaki_kiri}
            />
          </label>
        </Grid.Column>
      </Grid.Row>
        ...
        <Grid.Column>
          <label className="block">
            <Select
              clearable
              fluid
              options={DropdownOptions.extermitas.umum.sensorik}
            />
          </label>
        </Grid.Column>
      </Grid.Row>
      ...
      {isArteri && (
        <Fragment>
          ...
          <Grid.Row columns="equal" className="pb-0">
            ...
            <Grid.Column>
              {CheckboxOptions.extermitas.umum.arteri.lokasi.map((data) => {
                return (
                  <label
                    key={data.key}
          ...
          <Grid.Row columns="equal" className="pb-0 mt-2">
            ...
            <Grid.Column>
              {CheckboxOptions.extermitas.umum.arteri.keadaan.map((data) => {
                return (
                  <label
                    key={data.key}
                    className={'block ' + (data.key === 0 ? '' : 'mt-3')}
          ...
          <Grid.Row columns="equal" className="pb-0 mt-2">
            ...
            <Grid.Column>
              {CheckboxOptions.extermitas.umum.arteri.balutan.map((data) => {
                return (
                  <label
                    key={data.key}
                    className={'block ' + (data.key === 0 ? '' : 'mt-3')}
      ...
      {isIV && (
        <Fragment>
          ...
          <Grid.Row columns="equal" className="pb-0">
            ...
            <Grid.Column>
              {CheckboxOptions.extermitas.umum.iv.lokasi.map((data) => {
                return (
                  <label
                    key={data.key}
                    className={'block ' + (data.key === 0 ? '' : 'mt-3')}
          ...
          <Grid.Row columns="equal" className="pb-0 mt-2">
            ...
            <Grid.Column>
              {CheckboxOptions.extermitas.umum.iv.keadaan.map((data) => {
                return (
                  <label
                    key={data.key}
                    className={'block ' + (data.key === 0 ? '' : 'mt-3')}
          ...
          <Grid.Row columns="equal" className="pb-0 mt-2">
            ...
            <Grid.Column>
              {CheckboxOptions.extermitas.umum.iv.balutan.map((data) => {
                return (
                  <label
                    key={data.key}
                    className={'block ' + (data.key === 0 ? '' : 'mt-3')}
      ...
      {isVena && (
        <Fragment>
          ...
          <Grid.Row columns="equal" className="pb-0">
            ...
            <Grid.Column>
              {CheckboxOptions.extermitas.umum.vena.lokasi.map((data) => {
                return (
                  <label
                    key={data.key}
                    className={'block ' + (data.key === 0 ? '' : 'mt-3')}
          ...
          <Grid.Row columns="equal" className="pb-0 mt-2">
            ...
            <Grid.Column>
              {CheckboxOptions.extermitas.umum.vena.keadaan.map((data) => {
                return (
                  <label
                    key={data.key}
                    className={'block ' + (data.key === 0 ? '' : 'mt-3')}
          ...
          <Grid.Row columns="equal" className="pb-0 mt-2">
            ...
            <Grid.Column>
              {CheckboxOptions.extermitas.umum.vena.balutan.map((data) => {
                return (
                  <label
                    key={data.key}
                    className={'block ' + (data.key === 0 ? '' : 'mt-3')}
