...
import Mata from './PartialAnastesi/Mata';
import Leher from './PartialAnastesi/Leher';
import Jantung from './PartialAnastesi/Jantung';
import Paru from './PartialAnastesi/Paru';
import Abdomen from './PartialAnastesi/Abdomen';
import Kulit from './PartialAnastesi/Kulit';
import TulangBelakang from './PartialAnastesi/TulangBelakang';
import SistemSaraf from './PartialAnastesi/SistemSaraf';
import Genetalia from './PartialAnastesi/Genetalia';
import Extermitas from './PartialAnastesi/Extermitas';
...
export default function Umum() {
  ...
  const [isLeher, setIsLeher] = useState(false);
          ...
          <Grid.Column>
            ...
            >
              ...
              <Button
                icon
                primary={isLeher}
                onClick={() => setTypeAndOpenDetail('leher')}
              >
                <Icon name="list" />
              </Button>
            </Input>
