...
import Mata from './PartialBersalin/Mata';
import Payudara from './PartialBersalin/Payudara';
import Jantung from './PartialBersalin/Jantung';
import Paru from './PartialBersalin/Paru';
import Abdomen from './PartialBersalin/Abdomen';
import Kulit from './PartialBersalin/Kulit';
import TulangBelakang from './PartialBersalin/TulangBelakang';
import SistemSaraf from './PartialBersalin/SistemSaraf';
import Genetalia from './PartialBersalin/Genetalia';
import Extermitas from './PartialBersalin/Extermitas';

export default function Bersalin() {
  const [isModalOpen, setIsModalOpen] = useState(false);
  const [typeModal, setTypeModal] = useState('');

  const [isMata, setIsMata] = useState(false);
  const [isPayudara, setIsPayudara] = useState(false);
          ...
          <Grid.Column>
            ...
            >
              ...
              <Button
                icon
                primary={isPayudara}
                onClick={() => setTypeAndOpenDetail('payudara')}
              >
                <Icon name="list" />
              </Button>
            </Input>
