...
import Kepala from './PartialBayi/Kepala';
import Mata from './PartialBayi/Mata';
import Mulut from './PartialBayi/Mulut';
import Jantung from './PartialBayi/Jantung';
import Paru from './PartialBayi/Paru';
import Abdomen from './PartialBayi/Abdomen';
import Kulit from './PartialBayi/Kulit';
import TulangBelakang from './PartialBayi/TulangBelakang';
import SistemSaraf from './PartialBayi/SistemSaraf';
import Genetalia from './PartialBayi/Genetalia';
import Extermitas from './PartialBayi/Extermitas';
...
export default function Umum() {
  ...
  const [isMulut, setIsMulut] = useState(false);
          ...
          <Grid.Column>
            ...
            >
              ...
              <Button
                icon
                primary={isKepala}
                onClick={() => setTypeAndOpenDetail('kepala')}
              >
                <Icon name="list" />
              </Button>
            </Input>
          ...
          <Grid.Column>
            ...
            >
              ...
              <Button
                icon
                primary={isMulut}
                onClick={() => setTypeAndOpenDetail('mulut')}
              >
                <Icon name="list" />
              </Button>
            </Input>
