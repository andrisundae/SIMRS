...
class List extends Component {
    ...
    _onCellValueChanged(params) {
        ...
        if ((colId === "jml_real_bed" || colId === "jml_extra_bed") && (params.oldValue !== params.value)) {
    ...
    _getColumnDefs() {
        return [
            ...
            {
                headerName: this.props.t(`${this.props.resource}:header.column.nama_unit_layanan`),
                field: "nama_unit_layanan",
            },
            {
                headerName: this.props.t(`${this.props.resource}:header.column.nama_kelas`),
                field: "nama_kelas",
                width: 100
            },
            {
                headerName: this.props.t(`${this.props.resource}:header.column.jml_real_bed`),
                field: "jml_real_bed",
                width: 100,
                editable: true,
            ...
            {
                headerName: this.props.t(`${this.props.resource}:header.column.jml_extra_bed`),
                field: "jml_extra_bed",
                width: 100,
                editable: true,
                cellEditor: 'numericInputRenderer',
            ...
            {
                headerName: this.props.t(`${this.props.resource}:header.column.sisa_real_bed`),
                field: "sisa_real_bed",
                width: 100,
                cellClass: "ag-number-cell",
                pinnedRowCellRenderer: "footerPinnedRowRenderer",
            ...
            {
                headerName: this.props.t(`${this.props.resource}:header.column.sisa_extra_bed`),
...
const mapStateToProps = function (state) {
    ...
    const { columnDefs, columnFooterDefs, editedCell, post, error, selectedRow } = module;
