...
import ScreeningNyeriGeriatriLabel from './Label';

export default function Add() {
  const history = useHistory();
  const formLabel = ScreeningNyeriGeriatriLabel.formLabel;
  ...
  return (
    <Fragment>
      <Modal.Header className="text-xl">
        ...
        {ScreeningNyeriGeriatriLabel.headerLabel}
        <label className="mx-2">&bull;</label>
        {ScreeningNyeriGeriatriLabel.descriptionLabel}
      </Modal.Header>
      <Modal.Content scrolling>
        <Grid>
          ...
          <Grid.Row columns="equal" className="pb-0">
            ...
            <Grid.Column>
              <label className="block">
                {ScreeningNyeriGeriatriLabel.skala.map((data, index) => {
                  return (
                    <Radio
                      key={index}
                      className="mr-14"
          ...
          <Grid.Row columns="equal" className="pb-0 mt-2">
            ...
            <Grid.Column>
              {ScreeningNyeriGeriatriLabel.penyebabNyeri.map((data, index) => {
                return (
                  <label
                    key={index}
          ...
          <Grid.Row columns="equal" className="pb-0 mt-2">
            ...
            <Grid.Column>
              {ScreeningNyeriGeriatriLabel.kualitasNyeri.map((data, index) => {
                return (
                  <label
                    key={index}
                    className={className('block', {
          ...
          <Grid.Row columns="equal" className="pb-0">
            ...
            <Grid.Column>
              {ScreeningNyeriGeriatriLabel.frekuensiNyeri.map((data, index) => {
                return (
                  <label
                    key={index}
                    className={className('block', {
          ...
          <Grid.Row columns="equal">
            ...
            <Grid.Column>
              {ScreeningNyeriGeriatriLabel.intervensi.map((value) => {
                return (
                  <label
                    key={value.key}
