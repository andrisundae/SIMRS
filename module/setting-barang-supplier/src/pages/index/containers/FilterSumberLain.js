              ...
              <Grid className="form-grid">
                <Grid.Row className="form-row">
                  <Grid.Column width="3" className="field">
                    <label>
                      <Trans i18nKey={this._getKey('label.field.supplier')} />
                    </label>
                  </Grid.Column>
                  <Grid.Column width="11" className="field">
                    <Select
                      ...
                      inputRef={this.supplier}
                      value={this._getSelect2Value('supplier')}
                      onChange={(selected) =>
                        this._handleSelect2SumberLain('supplier', selected)
                      }
                      options={dataSumberLain.supplier}
                    />
                  </Grid.Column>
                </Grid.Row>
              </Grid>
