...
import { isDisableDatatable } from '../reducer';
...
class List extends Component {
    ...
    render() {
        return (
            <DatatableServerSide
                ...
                disabled={this.props.isDisableDatatable}
            />
        )
    }
    ...
    _getDataSource() {
        ...
        return {
            rowCount: null,
            getRows: (params) => {
                const { filter_index, filter_value, klasifikasi, status } = _this.props.filterPost;
                let filterPost = { filter_index, filter_value, klasifikasi, status };
...
const mapStateToProps = function (state) {
    ...
    return {
        ...
        isDisableDatatable: isDisableDatatable(filter.post, filter.currentPost),
        post: module.post,
