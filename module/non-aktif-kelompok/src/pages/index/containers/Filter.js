...
import { Input, Form, Grid, Button, Segment } from 'semantic-ui-react';
import { remote } from 'electron';
import { Trans } from 'react-i18next';

import { Select, ResetButton, SearchButton } from '@simrs/components';
                                    ...
                                    <Grid.Row className="form-row">
                                        <Grid.Column width="8" className="field">
                                            <Button.Group size="mini">
                                                <ResetButton as="a" ref={this.reset} onClick={this._handleReset}/>
                                                <Button.Or as="a"/>
                                                <SearchButton as="a" ref={this.search} onClick={this._handleSubmit} />
                                            </Button.Group>
