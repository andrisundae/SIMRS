...
class List extends Component {
    ...
    _getColumnDefs() {
        return [
            {
                headerName: this.props.t(`${this.props.resource}:header.column.nama_versi_tarif`),
            ...
            {
                headerName: this.props.t(`${this.props.resource}:header.column.nama_layanan`),
                field: "nama_layanan",
            },
            {
    ...
    _getDataSource() {
        ...
        return {
            rowCount: null,
            getRows: (params) => {
                const { versi_tarif, nama_layanan, klasifikasi, status, kelompok, kelas } = _this.props.filterPost;
                let filterPost = { versi_tarif, nama_layanan, klasifikasi, status, kelompok, kelas };
