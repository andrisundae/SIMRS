...
export default function Main() {
  ...
  function checkPathname(type) {
    switch (type) {
      case 'add':
        return {
          status:
            '/pengkajian-khusus/screening-apgar-score/add' ===
      ...
      case 'ubah-kelahiran':
        return {
          status:
            '/pengkajian-khusus/screening-apgar-score/ubah-kelahiran' ===
      ...
      case 'add-riwayat':
        return {
          status:
            '/pengkajian-khusus/screening-apgar-score/add-riwayat' ===
  ...
  return (
    <Router basename="/detail-rekam-medis/umum/pengkajian-khusus/screening-apgar-score">
