...
class FilterSumberLain extends Component {
    ...
    _handleSelect2Filter(name, selected) {
        ...
        switch (name) {
            case 'instalasi':
                type = 'optional';
                filter = { target: "dataSumber", name: "unit_penunjang", by: "instalasi" };
                break;
            default:
                break;
        }
                    ...
                    <Grid.Row className="form-row">
                      ...
                      <Grid.Column width="9" className="field">
                        <Select
                            ...
                            onKeyDown={(e) => this._onFocusElement(e, 'unit_penunjang')}
                ...
                <Grid.Row>
                    <Grid.Column>
                        <Grid className="form-grid">
                            <Grid.Row className="form-row">
                                <Grid.Column width="5" className="field">
                                    <label>{t(this._getKey('label.field.unit_penunjang'))}</label>
                                </Grid.Column>
                                <Grid.Column width="9" className="field">
                                    <Select
                                        name="unit_penunjang"
                                        placeholder={t(this._getKey('placeholder.field.unit_penunjang'))}
                                        inputRef={this.unit_penunjang}
                                        value={this._getSelect2Value('unit_penunjang')}
                                        onChange={(selected) => this._handleSelect2SumberLain('unit_penunjang', selected)}
