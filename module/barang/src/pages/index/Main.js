...
class Main extends Component {
    ...
    _getColumnDefs() {
        return [
            ...
            {
                headerName: this.props.t(`${this.props.resource}:header.column.golongan`),
                field: "golongan_barang",
                width: 300
            },
            {
                headerName: this.props.t(`${this.props.resource}:header.column.satuan_terkecil`),
            ...
            {
                headerName  : this.props.t(`${this.props.resource}:header.column.persentase_profit`),
            ...
            {
                headerName: this.props.t(`${this.props.resource}:header.column.otomatis_update_harga`),
                field: "str_auto_update",
                width: 60
            },
            {
                headerName: this.props.t(`${this.props.resource}:header.column.include_diskon_beli`),
                field: "str_include_diskon",
                width: 60
            },
            {
                headerName  : this.props.t(`${this.props.resource}:header.column.harga_jual`),
                field       : "harga_jual",
                cellRenderer: 'currencyRenderer',
                width       : 100,
                cellClass   : "ag-number-cell",
            ...
            {
                headerName: this.props.t(`${this.props.resource}:header.column.metode_update_harga`),
