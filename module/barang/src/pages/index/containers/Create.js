...
class Create extends Component {
                    ...
                    <Grid.Row>
                        <Grid.Column>
                            <Grid>
                                ...
                                <Grid.Row className="form-row">
                                    <Grid.Column width="6" className="required field right aligned">
                                ...
                                <Grid.Row className="form-row">
                                    ...
                                    <Grid.Column width="10" className="field">
                                        <Select
                                          ...
                                          onChange={e => this._handleSelectOption("id_jenis", "jenis_barang", e)}
                                          value={this._generateSelectedValue(post.id_jenis, post.jenis_barang)}
                                          onKeyDown={(e) => this._onFocusElement(e, "kelompok_barang")}
                                ...
                                <Grid.Row className="form-row">
                                    ...
                                    <Grid.Column width="10" className="field">
                                        <Select
                                          ...
                                          isDisabled={isDisableForm}
                                          onChange={e => this._handleSelectOption("id_kelompok", "kelompok_barang", e)}
                                          value={this._generateSelectedValue(post.id_kelompok, post.kelompok_barang)}
                                          onKeyDown={(e) => this._onFocusElement(e, "golongan_barang")}
                                ...
                                <Grid.Row className="form-row">
                                    ...
                                    <Grid.Column width="10" className="field">
                                        <Select
                                          ...
                                          placeholder={t(this._getKey('placeholder.field.golongan'))}
                                          inputRef={this.golongan_barang}
                                          isDisabled={isDisableForm}
                                          onChange={e => this._handleSelectOption("id_golongan", "golongan_barang", e)}
                                          value={this._generateSelectedValue(post.id_golongan, post.golongan_barang)}
                                          onKeyDown={(e) => this._onFocusElement(e, "satuan_terkecil")}
                        ...
                        <Grid.Column>
                            <Grid>
                                <Grid.Row className="form-row">
                                    <Grid.Column width="6" className="required field right aligned">
                                        <label>{t(this._getKey('label.field.satuan_terkecil'))}</label>
                                    </Grid.Column>
                                    <Grid.Column width="10" className="field">
                                        <Select
                                          name="satuan_terkecil"
                                          placeholder={t(this._getKey('placeholder.field.satuan_terkecil'))}
                                          inputRef={this.satuan_terkecil}
                                          isDisabled={isDisableForm}
                                          onChange={e => this._handleSelectOption("id_satuan_terkecil", "satuan_terkecil", e)}
                                          value={this._generateSelectedValue(post.id_satuan_terkecil, post.satuan_terkecil)}
                                ...
                                <Grid.Row className="form-row">
                                    ...
                                    <Grid.Column width="10" className="field">
                                        <CurrencyInput
                                          ...
                                          onKeyDown={(e) => this._onFocusElement(e, 'persentase_profit')}
                                        />
                                    </Grid.Column>
                                </Grid.Row>
                                <Grid.Row className="form-row">
                                    <Grid.Column width="6" className="required field right aligned">
                                        <label>{t(this._getKey('label.field.persentase_profit'))}</label>
                                    </Grid.Column>
                                    <Grid.Column width="10" className="field">
                                        <CurrencyInput
                                          ...
                                          decimalSeparator="," 
                                          thousandSeparator="."
                                          onChange={e => this._handleCurency("persentase_profit", e)}
                                ...
                                <Grid.Row className="form-row">
                                    ...
                                    <Grid.Column width="10" className="field">
                                        <Checkbox
                                          ...
                                          disabled={isDisableForm}
                                          onChange={this._handleInputChange}
                                          onKeyDown={(e) => this._onFocusElement(e, 'otomatis_update')}
                                          inputRef={this.aktif}
                                          label={""}
                                        />
                                    </Grid.Column>
                        ...
                        <Grid.Column>
                            ...
                            <Segment attached size="mini">
                                <Grid>
                                    <Grid.Row className="form-row">
                                        <Grid.Column width="8" className="required field right aligned">
                                            <label>{t(this._getKey('label.field.otomatis_update'))}</label>
                                        </Grid.Column>
                                        <Grid.Column width="8" className="field">
                                            <Checkbox
                                              ...
                                              disabled={isDisableForm}
                                              onChange={this._handleInputChange}
                                              onKeyDown={(e) => this._onFocusElement(e, 'include_diskon')}
                                    ...
                                    <Grid.Row className="form-row">
                                        <Grid.Column width="8" className="required field right aligned">
                                            <label>{t(this._getKey('label.field.include_diskon'))}</label>
                                        </Grid.Column>
                                        <Grid.Column width="8" className="field">
                                            <Checkbox
                                              ...
                                              disabled={isDisableForm}
                                              onChange={this._handleInputChange}
                                              onKeyDown={(e) => this._onFocusElement(e, 'metode_update_harga_jual')}
                                    ...
                                    <Grid.Row className="form-row">
                                    <Grid.Column width="8" className="required field right aligned">
                                        <label>{t(this._getKey('label.field.metode_update'))}</label>
                                    </Grid.Column>
                                    <Grid.Column width="8" className="field">
                                        <Select
                                          name="metode_update_harga_jual"
                                          placeholder={t(this._getKey('placeholder.field.metode_update'))}
                                          inputRef={this.metode_update_harga_jual}
                                          isDisabled={isDisableForm}
                                          onChange={e => this._handleSelectOption("id_metode_update_harga", "metode_update_harga_jual", e)}
                                          value={this._generateSelectedValue(post.id_metode_update_harga, post.metode_update_harga_jual)}
    ...
    _handleSelectOption(idx, val, selected){
        this.props.action.onChangeSelect(this.props.resource, {idx, val, selected});
    }

    _handleCurency(name, e){
        let { t } = this.props;
        let curency = e.replace(t(this._getKey('curency.prefix')), "").replace(t(this._getKey('curency.suffix.percent')), "");
            curency = parseFloat(curency.replace(/\./g, '').replace(/,/g, '.'));
        this.props.action.onChangeInput(this.props.resource, { name, value: curency });
    }
...
const mapStateToProps = function (state) {
    const { post, dataForm, statusForm, focusElement, isSubmitted, submitting} = state.default.module;
