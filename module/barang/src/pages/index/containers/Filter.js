    ...
    return [
      {
        key: 'barcode',
        value: 'barcode',
        text: this.props.t(this._getKey('header.column.barcode')),
      },
      {
        key: 'nama',
        value: 'nama',
      ...
      },
      {
        key: 'jenis_barang',
        value: 'idJenis',
        text: this.props.t(this._getKey('header.column.jenis')),
      },
      {
        key: 'kelompok_barang',
        value: 'idKelompok',
        text: this.props.t(this._getKey('header.column.kelompok')),
      },
      {
        key: 'golongan_barang',
        value: 'idGolongan',
        text: this.props.t(this._getKey('header.column.golongan')),
      },
      {
        key: 'satuan_terkecil',
        value: 'idSatuan',
        text: this.props.t(this._getKey('header.column.satuan_terkecil')),
      },
      {
        key: 'st_expired',
        value: 'stExpired',
        text: this.props.t(this._getKey('header.column.st_expired')),
      },
      {
        key: 'otomatis_update_harga',
        value: 'autoUpdateHargaJual',
        text: this.props.t(this._getKey('header.column.otomatis_update_harga')),
      },
      {
        key: 'metode_update_harga',
        value: 'metodeUpdateHargaJual',
        text: this.props.t(this._getKey('header.column.metode_update_harga')),
      },
      {
        key: 'include_diskon_beli',
        value: 'includeDiskonPembelian',
        text: this.props.t(this._getKey('header.column.include_diskon_beli')),
      },
      {
        key: 'aktif',
        value: 'aktif',
        text: this.props.t(this._getKey('header.column.aktif')),
      },
    ];
  }
}
