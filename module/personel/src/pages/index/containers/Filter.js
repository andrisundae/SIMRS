...
class Filter extends Component {
  constructor(props) {
    ...
    this._handleFilterStatusAplikasiChange = this._handleFilterStatusAplikasiChange.bind(
      this
    );
  }
...
const mapStateToProps = function (state, props) {
  ...
  const optionsStatusAplikasi = filter.data.options_status_aplikasi.map(
    (row) => ({
      text: row.label,
      value: row.id,
      key: row.id,
    ...
    action: bindActionCreators(
      {
        ...
        onChangeFilterStatusAplikasi:
          filterIndexActions.onChangeFilterStatusAplikasi,
      },
      dispatch
    ),
  };
