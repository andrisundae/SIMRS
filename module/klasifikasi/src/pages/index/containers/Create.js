...
class Create extends Component {
    constructor(props) {
        ...
        this._handleChangeJenisKlasifikasi = this._handleChangeJenisKlasifikasi.bind(this);
        this._handleInputChange = this._handleInputChange.bind(this);
                            ...
                            <Grid>
                                <Grid.Row className="form-row">
                                    <Grid.Column width="6" className="required field">
                                        <label>{t(this._getKey('label.field.jenis_klasifikasi'))}</label>
                                    </Grid.Column>
                                    <Grid.Column width="10" className="field">
                                        <Select
                                            name="jenis_klasifikasi"
                                            placeholder={t(this._getKey('placeholder.field.jenis_klasifikasi'))}
    ...
    _getJenisKlasifikasiValue() {
        ...
        if (post.jenis_klasifikasi && post.nama_jenis_klasifikasi) {
            value = { value: post.jenis_klasifikasi, label: post.nama_jenis_klasifikasi };
        }
