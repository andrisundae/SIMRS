...
class Main extends Component {
    constructor(props) {
        ...
        this.subResource = '_billing_master_tarif_layanan';
    }
    ...
    render() {
        return (
            <Module
                ...
                caption={this.props.t(`${this.props.resource}:layanan.title`, { kelompok: this.props.location.state.nama_kelompok})}
                isChildren={true}
    ...
    componentDidMount() {
        this.props.action.openForm(this.props.resource, this.subResource, { kelompok: this.props.match.params.kelompok });
    }
