...
const mapStateToProps = function (state, props) {
    return {
        customPermissions: {
            canAdd: isGranted(props.permissions, 'tambah_layanan'),
            canEdit: isGranted(props.permissions, 'koreksi_layanan'),
            canDelete: isGranted(props.permissions, 'hapus_layanan')
        },
    }
}
