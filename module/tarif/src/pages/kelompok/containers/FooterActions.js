...
const mapStateToProps = function (state, props) {
  ...
  const isNotTempatTidur = post.selectedKlasifikasi
    ? post.selectedKlasifikasi.alias !== 'tempat_tidur'
      ? true
      : false
    : false;
  ...
  return {
    customPermissions: {
      canAdd:
        isGranted(props.permissions, 'tambah_kelompok') && isNotTempatTidur,
      canEdit:
        isGranted(props.permissions, 'koreksi_kelompok') && isNotTempatTidur,
      canDelete:
        isGranted(props.permissions, 'hapus_kelompok') && isNotTempatTidur,
    },
  };
};
