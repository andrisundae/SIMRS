...
class Filter extends Component {
    ...
    render() {
        const { optionsKlasifikasi, isDisableNext, isDisablePrev, subResource, postFilter, isDisableForm, resource, minCharSearch, t } = this.props;
    ...
    _onClickNext(e) {
        ...
        this.props.history.push({
            pathname: `/layanan/${this.props.selectedRow}`,
            state: {
                layanan: true,
                id_kelompok: this.props.selectedRow,
                nama_kelompok: this.props.post.nama
            }
        });
    }
}
