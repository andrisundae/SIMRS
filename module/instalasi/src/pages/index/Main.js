    ...
    return [
      ...
      },
      {
        headerName: this.props.t(
          `${this.props.resource}:header.column.jenis_layanan`
        ),
        field: 'nama_jenis_layanan',
      },
      {
        headerName: this.props.t(
          `${this.props.resource}:header.column.kelompok_jenis_layanan`
        ),
        field: 'nama_kelompok_jenis_layanan',
      },
      {
        headerName: this.props.t(
          `${this.props.resource}:header.column.st_sebagai_asal_kunjungan`
        ),
