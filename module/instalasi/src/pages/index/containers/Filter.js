  ...
  _getFilterColumns() {
    return [
      ...
      },
      {
        ...
        value: 'nama_jenis_layanan',
        text: this.props.t(this._getKey('header.column.jenis_layanan')),
      },
      {
        key: 'nama_kelompok_jenis_layanan',
        value: 'nama_kelompok_jenis_layanan',
        text: this.props.t(
          this._getKey('header.column.kelompok_jenis_layanan')
        ),
      },
    ];
  }
