...
class Create extends Component {
    constructor(props) {
        ...
        this._handleKelompokJenisLayananChange = this._handleKelompokJenisLayananChange.bind(this);
    ...
    render() {
        let { optionsJenisLayanan, optionsKelompokJenisLayanan, post, isDisableForm, t } = this.props;
                    ...
                    <Grid.Row>
                        <Grid.Column>
                            <Grid>
                                <Grid.Row className="form-row">
                                    ...
                                    <Grid.Column width="10" className="field">
                                        <Input
                                            ...
                                            onKeyDown={(e) => this._onFocusElement(e, 'jenis_layanan')}
                                        />
                                    </Grid.Column>
                                </Grid.Row>
                                <Grid.Row className="form-row">
                                    <Grid.Column width="6" className="required field">
                                        <label>{t(this._getKey('label.field.jenis_layanan'))}</label>
                                    </Grid.Column>
                                    <Grid.Column width="10" className="field">
                                        <Select
                                            name="jenis_layanan"
                                            placeholder={t(this._getKey('placeholder.field.jenis_layanan'))}
                                ...
                                <Grid.Row className="form-row">
                                    <Grid.Column width="6" className="required field">
                                        <label>{t(this._getKey('label.field.kelompok_jenis_layanan'))}</label>
                                    </Grid.Column>
                                    <Grid.Column width="10" className="field">
                                        <Select
                                            name="kelompok_jenis_layanan"
                                            placeholder={t(this._getKey('placeholder.field.kelompok_jenis_layanan'))}
    ...
    _handleJenisLayananChange(selected) {
        this.props.action.onChangeSelect2(this.props.resource, 'jenis_layanan', selected);
    }

    _handleKelompokJenisLayananChange(selected) {
        this.props.action.onChangeSelect2(this.props.resource, 'kelompok_jenis_layanan', selected);
    }
    ...
    _getKelompokJenisLayananValue() {
        ...
        if (post.kelompok_jenis_layanan && post.nama_kelompok_jenis_layanan) {
            value = { value: post.kelompok_jenis_layanan, label: post.nama_kelompok_jenis_layanan };
        }
