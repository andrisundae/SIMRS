...
function* populateForm({ meta }) {
    ...
    try {
        ...
        if (jenisLayanan.status) {
            yield put(getOptionsJenisLayanan.requestSuccess(meta.resource, jenisLayanan.data));
        } else {
            yield put(getOptionsJenisLayanan.requestFailure(meta.resource, jenisLayanan.message));
        }

        let kelompokJenisLayanan = yield call(api.getOptionsKelompokJenisLayanan);
        if (kelompokJenisLayanan.status) {
            yield put(getOptionsKelompokJenisLayanan.requestSuccess(meta.resource, kelompokJenisLayanan.data));
        } else {
            yield put(getOptionsKelompokJenisLayanan.requestFailure(meta.resource, kelompokJenisLayanan.message));
        }
