        ...
        <Form>
          <Form.Field>
            <Segment compact className="p-2.5">
              <Checkbox label="Ikut serta rawat bersama" />
            </Segment>
          </Form.Field>
          <Form.Field>
            <label>Kepada</label>
          ...
          <Form.Field>
            <Grid>
              ...
              <Grid.Row columns="equal" className="pb-0">
                <Grid.Column width="4" className="font-bold mt-2">
                  Tanggal Pengalihan
                </Grid.Column>
                <Grid.Column>
              ...
              <Grid.Row columns="equal">
                ...
                <Grid.Column>
                  <label className="block">
                    <Radio label="Agar sesuai dengan kebutuhan perawatan dan pengobatan pasien" />
                  </label>
                  <label className="block mt-3">
                    <Radio label="Permintaan pasien" />
                  </label>
                </Grid.Column>
              </Grid.Row>
            </Grid>
